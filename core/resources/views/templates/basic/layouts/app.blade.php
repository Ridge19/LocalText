...
<body>
    ...
    <script src="{{ $activeTemplateTrue . 'js/viewport.jquery.js' }}"></script>
    <script src="{{ $activeTemplateTrue . 'js/odometer.min.js' }}"></script>
    <script src="{{ $activeTemplateTrue . 'js/custom-select.min.js' }}"></script>
    <script src="{{ 'assets/global/js/datepicker.en.js' }}"></script>
    <script src="{{ 'assets/global/js/datepicker.min.js' }}"></script>
    <script src="{{ $activeTemplateTrue . 'js/lightcase.js' }}"></script>
    <script src="{{ $activeTemplateTrue . 'js/slick.js' }}"></script>
    <script src="{{ $activeTemplateTrue . 'js/main.js' }}"></script>
