                    ...
                    <div class="row justify-content-center gy-sm-4 gy-3">
                        <div class="card-header">
                            @if (session('PURCHASE_PLAN'))
                                <h4 class="payment-card-title">@lang('Confim Payment')</h4>
                            @else
                                <h4 class="payment-card-title">@lang('New Deposit')</h4>
                            @endif
                        </div>
                        <div class="col-lg-6">
                                ...
                                <div class="deposit-info">
                                    ...
                                    <div class="deposit-info__input">
                                        <div class="deposit-info__input-group input-group">
                                            ...
                                            <input type="number" class="form-control form--control amount" name="amount" placeholder="@lang('00.00')" step="any" value="{{ old('amount', $amount) }}" autocomplete="off" {{ $amount ? 'readonly' : '' }}>
                                        </div>
                                    </div>
                                </div>
                                <hr>
