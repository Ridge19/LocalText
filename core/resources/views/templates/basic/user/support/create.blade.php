    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card custom--card">
                <div class="card-body">
                    <form action="{{ route('user.ticket.store') }}" class="disableSubmission" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 form-group">
                                ...
                                <textarea name="message" id="inputMessage" rows="6" placeholder="@lang('Write your message here')"
                            ...
                            <div class="col-md-9">
                                ...
                                <p class="mb-2">
                                    <span class="text--info">
                                        @lang('Max 5 files can be uploaded | Maximum upload size is '
...
@push('breadcrumb-plugins')
    <a href="{{ route('user.ticket.index') }}" class="btn btn--sm btn--base mb-2">
        <i class="las la-tags"></i> @lang('My Support Ticket')
    </a>
@endpush
                    ...
                    <div class="col-lg-4 col-md-12 removeFileInput">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <button type="button" 
                                        class="form-control-text removeFile bg--danger text-white border--danger">
