...
class ReportController extends Controller
{
    ...
    public function purchaseHistory(Request $request, $userId = null)
    {
        $pageTitle = 'Purchase Logs';

        $purchases = PurchasePlan::searchable(['plan:name', 'user:username'])->filter(['payment_type'])->dateFilter()->orderBy('id', 'desc')->with(['user', 'gateway', 'plan']);
        if ($userId) {
