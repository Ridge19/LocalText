...
class AdminController extends Controller
{
    public function dashboard()
    {
        ...
        $smsQuery = Sms::whereDate('created_at', Carbon::today());
        $sms['total']       =  (clone $smsQuery)->count();
        $sms['scheduled']   =  (clone $smsQuery)->scheduled()->count();
        $sms['delivered']   =  (clone $smsQuery)->delivered()->count();
        $sms['failed']      =  (clone $smsQuery)->failed()->count();

        $plan['total']      =  Plan::count();
        $plan['active']     =  Plan::active()->count();
        ...
        return view('admin.dashboard', compact('pageTitle', 'widget', 'chart', 'deposit', 'sms', 'plan', 'device', 'contact', 'campaign', 'batch'));
    }

    public function depositAndPurchaseReport(Request $request)
    {
        ...
        $purchases = PurchasePlan::whereDate('created_at', '>=', $request->start_date)
            ->whereDate('created_at', '<=', $request->end_date)
