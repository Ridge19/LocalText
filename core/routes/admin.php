...
Route::middleware('admin')->group(function () {
    Route::controller('AdminController')->group(function () {
        ...
        Route::get('chart/deposit-purchase', 'depositAndPurchaseReport')->name('chart.deposit.purchase');
    ...
    // Contact Manager
    Route::prefix('contact')->controller("ContactController")->name('contact.')->group(function () {
    ...
    Route::controller('ReportController')->prefix('report')->name('report.')->group(function () {
        ...
        Route::get('purchase', 'purchaseHistory')->name('purchase.history');
    ...
    Route::controller('GeneralSettingController')->group(function () {
        ...
        // upload apk
        Route::get('apk/upload', 'apk')->name('apk');
        Route::post('apk-upload', 'uploadApk')->name('upload.apk');
